...
function ChainLogo({
  ...
  if (!chain.logo) {
    return (
      <span
        className={cn(
          'inline-flex items-center justify-center rounded-full border border-border bg-muted text-muted-foreground',
          className,
        )}
...
export default function LaunchpadPage({ onSelectToken }: LaunchpadPageProps) {
